...
public class CreateRoom extends HttpServlet {
    ...
    RequestDispatcher rd;
        try
        {
    System.out.println("Inside create room"+request.getParameter("cr_roomname"));
Connection con = Connections.give_Connection();
String room=request.getParameter("cr_roomname");
    Statement statement=con.createStatement();
statement.executeUpdate("insert into rooms values('"+room+"')");
